...
def main():
    ...
    if args.resume:
        ...
        checkpoint1 = torch.load("/root/hcc/exp1/save/wl/prune/transformed_vgg.pth.tar").get('state_dict')
    ...
    test_acc = validate(val_loader, model_1, criterion)
   

    
    return

def validate(val_loader, model_1 , criterion):
